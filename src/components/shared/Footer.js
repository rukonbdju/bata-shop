            ...
            <section className='flex flex-raw items-center w-4/5 mx-auto justify-between'>
                <div className='lg:basis-2/4'>
                    ...
                    <label className="relative block ">
                        ...
                        <input class="placeholder:italic placeholder:text-slate-500 block bg-white w-full border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Enter your email." type="text" name="search" />
                    </label>
                </div>
